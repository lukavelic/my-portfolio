            ...
            <PopAnimation>
                <header className="mb-6 flex items-center justify-between text-white">
                    <div className="flex gap-4 max-md:flex-col md:items-center md:justify-between">
                        ...
                        <p className=" text-5xl  font-medium">Hi, I'm Luka</p>
                    </div>
                    <nav className="flex justify-end gap-4 text-lg max-md:hidden">
                        <div id="projects" onClick={clickHandler}>
                            <Button
                                id="projects"
                                className="border-blue-600 bg-blue-600 font-semibold transition-all hover:cursor-pointer hover:bg-transparent"
                            >
                        ...
                        <div id="about" onClick={clickHandler}>
                            <Button
                                id="about"
                                className="border-teal-600 bg-teal-600 font-semibold transition-all hover:cursor-pointer hover:bg-transparent"
                            >
                        ...
                        <div id="contact" onClick={clickHandler}>
                            <Button
                                id="contact"
                                className="border-red-600 bg-red-600 font-semibold transition-all hover:cursor-pointer hover:bg-transparent"
                            >
                                Contact
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="flex flex-col items-center gap-2">
                        <div className="flex justify-center gap-4">
                            ...
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-6 w-6 fill-white transition-all hover:fill-indigo-600"
                                >
